        ...
        <div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8'>
                ...
                {teamMembers.map((member, index) => (
                    <div key={index} className='bg-white rounded-lg shadow-lg p-6 flex flex-col md:flex-row items-start md:items-center'>
                        {/* Profile Image */}
            ...
            <div className='bg-[#F9FCF8] px-6 md:px-40 py-8 text-center'>
