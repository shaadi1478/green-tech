                    ...
                    <div className="relative group">
                        ...
                        {organizationDropdown && (
                            <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg">
                                ...
                                <Link onClick={closeMenu} to="/services" className="block px-4 py-2 text-gray-700 hover:bg-green-100">Our Services</Link>
                                <Link onClick={closeMenu} to="/collabarate" className="block px-4 py-2 text-gray-700 hover:bg-green-100">Collabarate</Link>
                            </div>
                        )}
                    </div>
